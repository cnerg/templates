...
\gdef\@doctype{Dissertation}         %Default is dissertation, use "A Preliminary Report" for prelim

\gdef\@department{(Engineering Physics)} 
\gdef\@defensedate{2025-05-01}
\gdef\@committee{
  Paul P.H. Wilson, Professor, Engineering Physics\\
  Committee Member 2\\
  Another Committee Member\\
  And yet another committee member name and title\\
  }
